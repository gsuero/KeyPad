...
public class NumberGenerator {
	...
	public static void main(String[] args) {
		...
		List<Cell> invalidStarting = new ArrayList<Cell>();
		invalidStarting.add(new Cell(3,1));
		invalidStarting.add(new Cell(0,0));
		pad.setInvalidStartingKeys(invalidStarting);
